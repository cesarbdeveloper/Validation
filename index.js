...
const validation = (e, validation, element) => {
    ...
    formBtn.disabled = !usermaneValidation || !emailValidation || !phoneValidation || !passwordValidation || !confirmPasswordValidation || !countriesValidation ? true : false;
    if (validation) {
...
usernameInput.addEventListener('input', e => {
    usermaneValidation = USERNAME_REGEX.test(e.target.value);
    validation(e, usermaneValidation, usernameInput);
});
